...
for idx in range (TotalN):
  ...
  AL1 = NN_SigmoidFeedForward(Xi, BL1, WL1)
  AL2 = NN_SigmoidFeedForward(AL1, BL2, WL2)
  AL3 = NN_SigmoidFeedForward(AL2, BL3, WL3)
  AL4 = NN_SigmoidFeedForward(AL3, BL4, WL4)
  if AL4[0] > 0.5:
...
if overalScore > model['score']:
    with open("tree_fixed_write.json", "w") as write_file:
        ...
        Layers['layer@1']['Weight'] = WL1
        Layers['layer@2']['Weight'] = WL2
        Layers['layer@3']['Weight'] = WL3
        Layers['layer@4']['Weight'] = WL4
        Layers['layer@1']['Bias']   = BL1
        Layers['layer@2']['Bias']   = BL2
        Layers['layer@3']['Bias']   = BL3
        Layers['layer@4']['Bias']   = BL4
